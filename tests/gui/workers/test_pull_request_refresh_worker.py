...
from local_changes_viewer.gui.workers.pull_request_refresh_worker import (
    PullRequestRefreshWorker,
)
...
def test_repository_with_no_slash_emits_error_instead_of_raising(qapp) -> None:
    ...
    """
    worker = PullRequestRefreshWorker(github_client=object(), repository="no-slash-here", number=1)
    errors: list[str] = []
